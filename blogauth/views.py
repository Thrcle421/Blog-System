...
def send_validation(request):
    ...
    ValidationModel.objects.update_or_create(email=email,defaults={"validation":validation})
    send_mail("validation",message=f"Your validation is {validation}",recipient_list=[email], from_email=None)
